...
`npm run setup:local` will run `npm install`, then build all packages in the project. It also links the backend and create-amplify bin files into the project node_modules folder.
