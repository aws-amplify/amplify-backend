...
const assistantResponseRequestOptions = (authHeader: string, query: string, variables: AssistantMutationResponseInput): RequestInit => {
  return {
    method: 'POST',
    headers: {
...
const assistantResponseInput = (args: Args, content: string): AssistantMutationResponseInput => {
  return {
    input: {
