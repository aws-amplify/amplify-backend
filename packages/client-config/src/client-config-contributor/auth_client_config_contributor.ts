...
export class AuthClientConfigContributor implements ClientConfigContributor {
  ...
  contribute = ({
    ...
    const authClientConfig: AuthClientConfig | Record<string, never> = {
      ...
      aws_cognito_mfa_types: authOutput.payload.mfaTypes?.split(','),
      aws_cognito_mfa_configuration: authOutput.payload.mfaConfiguration,
      aws_cognito_username_attributes:
        authOutput.payload.usernameAttributes?.split(','),
      aws_cognito_signup_attributes:
        authOutput.payload.signupAttributes?.split(','),
      aws_cognito_verification_mechanisms:
        authOutput.payload.verificationMechanisms?.split(','),
    };
