...
export class VersionContributorV1_5 implements ClientConfigContributor {
...
export class AuthClientConfigContributor implements ClientConfigContributor {
  ...
  contribute = ({
    ...
    const authClientConfig: Partial<clientConfigTypesV1_4.AWSAmplifyBackendOutputs> =
      {};
    ...
    if (authOutput.payload.passwordlessOptions) {
      const passwordlessConfig = JSON.parse(
        authOutput.payload.passwordlessOptions,
      );
