// To parse this data:
//
//   import { Convert, ConfigTypesV1 } from "./file";
//
//   const configTypesV1 = Convert.toConfigTypesV1(json);
//
...
export class Convert {
   ...
   *
   */
  public static toConfigTypesV1(json: string): ConfigTypesV1 {
    return cast(JSON.parse(json), r('ConfigTypesV1'));
  }

  /**
   *
   */
  public static configTypesV1ToJson(value: ConfigTypesV1): string {
    return JSON.stringify(uncast(value, r('ConfigTypesV1')), null, 2);
  }
}
...
const typeMap: any = {
  ConfigTypesV1: o(
    [
      { json: '_version', js: '_version', typ: r('Version') },
