...
interface AmplifyStorageAccessRule {
    ...
    // (undocumented)
    groups?: {
        [k: string]: AmplifyStorageAccessActions[];
    };
    // (undocumented)
...
// @public
export const generateClientConfig: <T extends "1.4" | "0" | "1" | "1.1" | "1.2" | "1.3">(backendIdentifier: DeployedBackendIdentifier, version: T, awsClientProvider?: AWSClientProvider<{
