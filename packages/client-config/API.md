...
// @public
export const generateClientConfigToFile: (credentialProvider: AwsCredentialIdentityProvider, backendIdentifier: DeployedBackendIdentifier, outDir?: string, format?: ClientConfigFormat, logCallback?: ((filePath: string) => void) | undefined) => Promise<void>;
