...
import { BackendResourcesData, ResourceClientService } from '../services/resource_client_service';
...
describe('useResourceManager hook', () => {
  ...
  beforeEach(() => {
    mockResourceClientService.onSavedResources.mockReturnValue({ unsubscribe: vi.fn() });
    mockResourceClientService.onDeployedBackendResources.mockReturnValue({ unsubscribe: vi.fn() });
    mockResourceClientService.onCustomFriendlyNames.mockReturnValue({ unsubscribe: vi.fn() });
    mockResourceClientService.onCustomFriendlyNameUpdated.mockReturnValue({ unsubscribe: vi.fn() });
    mockResourceClientService.onCustomFriendlyNameRemoved.mockReturnValue({ unsubscribe: vi.fn() });
    mockResourceClientService.onError.mockReturnValue({ unsubscribe: vi.fn() });
    mockLoggingClientService.onActiveLogStreams.mockReturnValue({ unsubscribe: vi.fn() });
    mockLoggingClientService.onLogStreamStatus.mockReturnValue({ unsubscribe: vi.fn() });
    mockLoggingClientService.onLogStreamError.mockReturnValue({ unsubscribe: vi.fn() });
  });
  ...
  beforeEach(() => {
    ...
    vi.mocked(useResourceClientService).mockReturnValue(mockResourceClientService as unknown as ResourceClientService);
    vi.mocked(useLoggingClientService).mockReturnValue(mockLoggingClientService as unknown as LoggingClientService);
  });
  ...
  it('calls getDeployedBackendResources and getCustomFriendlyNames on mount', () => {
    ...
    expect(mockResourceClientService.getDeployedBackendResources).toHaveBeenCalled();
  ...
  it('registers event handlers for resources and custom friendly names', () => {
    ...
    expect(mockResourceClientService.onDeployedBackendResources).toHaveBeenCalled();
    expect(mockResourceClientService.onCustomFriendlyNames).toHaveBeenCalled();
    expect(mockResourceClientService.onCustomFriendlyNameUpdated).toHaveBeenCalled();
    expect(mockResourceClientService.onCustomFriendlyNameRemoved).toHaveBeenCalled();
  ...
  it('updates resources when onDeployedBackendResources handler is called', () => {
    ...
    mockResourceClientService.onDeployedBackendResources.mockImplementation(function(handler) {
  ...
  it('updates custom friendly names when onCustomFriendlyNames handler is called', () => {
    ...
    mockResourceClientService.onCustomFriendlyNames.mockImplementation(function(handler) {
  ...
  it('updates a custom friendly name when onCustomFriendlyNameUpdated handler is called', () => {
    ...
    mockResourceClientService.onCustomFriendlyNameUpdated.mockImplementation(function(handler) {
  ...
  it('removes a custom friendly name when onCustomFriendlyNameRemoved handler is called', () => {
    ...
    mockResourceClientService.onCustomFriendlyNameRemoved.mockImplementation(function(handler) {
  ...
  it('updates active log streams when onActiveLogStreams handler is called', () => {
    ...
    mockLoggingClientService.onActiveLogStreams.mockImplementation(function(handler) {
  ...
  it('updates active log streams when onLogStreamStatus handler is called', () => {
    ...
    mockLoggingClientService.onLogStreamStatus.mockImplementation(function(handler) {
  ...
  it('refreshResources calls getDeployedBackendResources', () => {
    ...
    expect(mockResourceClientService.getDeployedBackendResources).toHaveBeenCalledTimes(1);
  ...
  it('updateCustomFriendlyName calls resourceClientService.updateCustomFriendlyName', () => {
    ...
    expect(mockResourceClientService.updateCustomFriendlyName).toHaveBeenCalledWith('lambda1', 'My Lambda Function');
  });
  ...
  it('removeCustomFriendlyName calls resourceClientService.removeCustomFriendlyName', () => {
    ...
    expect(mockResourceClientService.removeCustomFriendlyName).toHaveBeenCalledWith('lambda1');
  });
  ...
  it('unsubscribes from events on unmount', () => {
    ...
    mockResourceClientService.onSavedResources.mockReturnValue({ unsubscribe: unsubscribeSavedResources });
    mockResourceClientService.onDeployedBackendResources.mockReturnValue({ unsubscribe: unsubscribeDeployedBackendResources });
    mockResourceClientService.onCustomFriendlyNames.mockReturnValue({ unsubscribe: unsubscribeCustomFriendlyNames });
    mockResourceClientService.onCustomFriendlyNameUpdated.mockReturnValue({ unsubscribe: unsubscribeCustomFriendlyNameUpdated });
    mockResourceClientService.onCustomFriendlyNameRemoved.mockReturnValue({ unsubscribe: unsubscribeCustomFriendlyNameRemoved });
    mockResourceClientService.onError.mockReturnValue({ unsubscribe: unsubscribeError });
    mockLoggingClientService.onActiveLogStreams.mockReturnValue({ unsubscribe: unsubscribeActiveLogStreams });
    mockLoggingClientService.onLogStreamStatus.mockReturnValue({ unsubscribe: unsubscribeLogStreamStatus });
    mockLoggingClientService.onLogStreamError.mockReturnValue({ unsubscribe: unsubscribeLogStreamError });
