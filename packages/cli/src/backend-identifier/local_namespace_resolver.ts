...
export class LocalNamespaceResolver implements NamespaceResolver {
  ...
  resolve = async () => {
    ...
    throw new AmplifyUserError('InvalidPackageJsonError', {
      ...
      resolution: `Ensure you are running Amplify backend commands in root of your project (i.e. in the parent of the 'amplify' directory).${EOL}Also ensure that your root package.json file has a "name" field.`,
    });
  };
}
