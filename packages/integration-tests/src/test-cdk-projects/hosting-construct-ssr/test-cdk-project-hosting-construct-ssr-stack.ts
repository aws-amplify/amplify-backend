 ...
 * This proves the construct works as a standalone L3 for SSR (Next.js) hosting.
 *
 * Usage:
 *   cdk deploy --app "npx tsx bin/app.ts" --require-approval never
 */
export class TestCdkProjectHostingConstructSsrStack extends cdk.Stack {
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    ...
    new cdk.CfnOutput(this, 'DistributionUrl', {
      ...
      description: 'CloudFront distribution URL for the SSR app',
    });
  }
}
