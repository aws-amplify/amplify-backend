...
// @public (undocumented)
export type AmplifyIoHostEventMessage<T> = {} & SimpleSpread<IoMessage<T>, AmplifyEventMessage | Pick<AmplifyEventMessage, 'action'> & Partial<Pick<AmplifyEventMessage, 'code'>>>;
