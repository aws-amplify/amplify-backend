...
// @public (undocumented)
export const colorNames: readonly [
  'Green',
  'Yellow',
  'Blue',
  'Magenta',
...
export const noticeSchema: z.ZodObject<
  {
          ...
          z.ZodObject<
            {
              ...
              backendComponent: z.ZodEnum<
                ['data', 'auth', 'function', 'storage', 'ai']
              >;
            },
            'strip',
            z.ZodTypeAny,
          ...
          z.ZodObject<
            {
              ...
              command: z.ZodEnum<
                ['sandbox', 'pipeline-deploy', 'generate', 'configure']
              >;
            },
            'strip',
            z.ZodTypeAny,
    ...
    frequency: z.ZodOptional<
      z.ZodEnum<['command', 'deployment', 'once', 'daily']>
    >;
  ...
  z.ZodTypeAny,
  {
    ...
    frequency?: 'deployment' | 'once' | 'command' | 'daily' | undefined;
...
export class NoticesManifestValidator {
  constructor(
    props?: NoticesManifestValidatorProps | undefined,
    _fetch?: typeof fetch,
  );
  // (undocumented)
