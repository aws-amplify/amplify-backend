...
import { Lazy, Names, Token } from 'aws-cdk-lib/core';
import { IntegrationConfig, IntegrationOptions, Method, AwsIntegration } from 'aws-cdk-lib/aws-apigateway';
 ...
 *
 */
export class LambdaIntegrationNoPremission extends AwsIntegration {
