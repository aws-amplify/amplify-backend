...
export const getCommand = (): Command => {
  return createCommand("link")
    .description(
      "Generate local files to connect a frontend to an Amplify backend"
    )
    .argument(
      "<env>",
      "The cloud environment to which the frontend will be linked"
    )
    .requiredOption(
      "-l, --language <languages...>",
      "Target languages for which to generate frontend config"
    )
